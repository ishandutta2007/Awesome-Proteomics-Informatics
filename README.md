...
- [💻 Open-Source Softwares](#-open-source-softwares)
  - [⚙️ Core Frameworks & Search / Quantification Engines](#-core-frameworks--search--quantification-engines)
...
| **[ProteinPilot](https://sciex.com/)** (SCIEX) | **$23.9B revenue** (FY2024, parent Danaher) | Quote-based; no public list price — sold as perpetual or subscription node licenses (e.g., 8-core vs 32-core) | Evaluation license available via SCIEX portal (registration required); bundled with SCIEX instrument purchases | Protein identification and relative quantification software featuring the Paragon algorithm for extensive PTM and variant searching, plus Pro Group for protein inference. Optimized for SCIEX instruments. | Peptide/protein ID with broad PTM coverage |
...
| **[PEAKS Studio](https://www.bioinfor.com/)** (Bioinformatics Solutions) | Private (bootstrapped; no public revenue) | Quote-based; no public list price — licenses tiered by compute (desktop 30+ threads / workstation 60+ threads); PEAKS Q & PTM sold as add-ons | 15-day free trial (complete version incl. DeepNovo); **PEAKS Studio Viewer** free forever | Complete bottom-up proteomics solution with powerful *de novo* sequencing (DeepNovo), database search, PTM/SPIDER homology, DDA & DIA support, sequence variant analysis, and quantification. Vendor-neutral. | *De novo* + database search & DIA/DDA |
